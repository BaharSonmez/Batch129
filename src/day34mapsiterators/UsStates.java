...
public enum  UsStates {
    //Sabit datalari Application icine gommek icin Enum kullaniriz.Cunku Applicatonlar kendi
   // basina ayakta durabilmelidir(standalone)
    //Mesela Apllicaton da yilin ay isimlerini koyman gerekicek ve sen google ihtiyac duymadan
    // "enum" dan al ve kullan.
/*
Enum bir data deposudur. Enum'in icine sabit, degisme ihtimali olmayan datalari koyariz.
Mesela yilin aylari, Haftanin gunleri, ABD'nin eyaletleri, Honda icin yapilan App'lerde Crv, Accord class'lari enum'dir. vs vs vs
Sabit datalari app'in icine gommek icin enum kullaniriz.
